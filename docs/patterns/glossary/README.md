...
eq<Int>()
//arrow.instances.IntEqInstance@7343cb2e
```
...
//arrow.data.ListKWApplicativeInstanceImplicits$instance$1@66529948
```
...
//arrow.core.OptionApplicativeInstanceImplicits$instance$1@39f47d72
```
